        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    manufacturingyear = table.Column<int>(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    flightnumber = table.Column<string>(
                        name: "flight_number",
                    ...
                    arrivedate = table.Column<DateTime>(
                        name: "arrive_date",
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    ...
                    flightdate = table.Column<DateTime>(
                        name: "flight_date",
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    seatnumber = table.Column<string>(
                        name: "seat_number",
                        type: "character varying(50)",
                        maxLength: 50,
                        nullable: false
            ...
            migrationBuilder.CreateIndex(name: "ix_flight_aircraft_id", table: "flight", column: "aircraft_id");
            ...
            migrationBuilder.CreateIndex(name: "ix_seat_flight_id", table: "seat", column: "flight_id");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "seat");
